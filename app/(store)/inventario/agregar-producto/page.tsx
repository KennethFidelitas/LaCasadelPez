...
import { FormularioAltaProducto } from '@/components/inventario/formulario-alta-producto'
...
async function SeccionFormulario() {
  const categorias = await cargarCategoriasProducto()
  return <FormularioAltaProducto categorias={categorias} />
}
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
      ...
      >
        ...
        <ChevronRight className="h-3 w-3" />
        <span className="text-foreground">Registrar producto</span>
      </nav>

      {/* Encabezado */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-foreground">Registrar nuevo producto</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Complete todos los campos para agregar un nuevo producto al catálogo. Los campos
